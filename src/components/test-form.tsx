...
import ZgoInput from './zgo-input';
...
const SignupForm = () => {
    ...
    return (
      ...
      <div className="row">
        ...
        <ZgoInput text="First Name" key="firstName" cb={(s: string) => formik.values.firstName = s} type="text" formik={formik} icon="user"/> 
        {formik.touched.firstName && formik.errors.firstName ? <div>{formik.errors.firstName}</div> : null}
        <ZgoInput text="Last Name" key="lastName" cb={(s: string) => formik.values.lastName = s} type="text" formik={formik}  />
